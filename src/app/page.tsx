      ...
      <main className="bg-gradient-to-br from-white-100 to-[#f69a9a] v">
        <div className="p-4 px-19  z-10 grid gap-6 ">
          ...
          <div className="flex justify-center">
            <Button
              className="m-auto inset-0 animate-gradient bg-gradient-to-r from-[#ffaa40]/50 via-[#9c40ff]/50 to-[#ffaa40]/50 bg-[length:var(--bg-size)_100%] p-[1px] ![mask-composite:subtract] [border-radius:inherit] text-black [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)]"
              size="sm"
            >
              🎉 | Introducing Pexlle
            </Button>
