...
const FilterList = ({ data, ke, pag, pagActive }: props) => {
  return (
      ...
      <div className="w-full h-full">
        <div className=" w-full p-4 bottom-0  text-black">
          ...
          <p className="text-sm text-[#737373] mt-1">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae dolore, laudantium, omnis ipsam eaque officia sed voluptatibus, assumenda ullam repudiandae quod. Quisquam consequuntur et accusamus eos cum repellendus eligendi atque, cumque quod veritatis qui!
          </p>
