      ...
      >
        ...
        >
          ...
          <div className="flex flex-col  w-full p-4 bg-[rgba(0,0,0,0.5)]  gap-2 text-white">
            <Badge className=" bg-black">Electronics</Badge>
            <h1 className="font-bold text-xl text-left">Wireless Earbuds</h1>
            ...
            <div className="flex items-center text-white gap-1">
              ...
              <span className="text-sm">(4567 sold)</span>
              <h2 className="font-bold ml-auto text-[1.2rem]">$45.78</h2>
            </div>
          </div>
          </div>
        </MorphingDialogTrigger>
