  ...
  return (
      ...
      >
        <MorphingDialogTrigger
          ...
          className="flex max-w-[240px] shadow-2xl shadow-[rgba(0,0,0,0.6)]     flex-col overflow-hidden rounded-none border border-zinc-950/10 bg-white dark:border-zinc-50/10 dark:bg-zinc-900 "
        >
          <MorphingDialogImage
