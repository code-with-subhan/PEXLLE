...
export const HousesData: Houses[] = [
    {
        ...
        price: "$13,600,000",
        BasicCreteria: ["Newly Build", "Furnished"],
        PropertyType : "House",
        Rooms : 3
    ...
    },
    {
        ...
        price: "$5,435,032",
        BasicCreteria: ["Parking Space","Swimming Pool"],
    ...
    },
    {
        ...
        price: "$25,430,000",
        BasicCreteria: ["Furnished" , "Parking Space"],
    ...
    },
    {
        ...
        price: "$456,000",
        BasicCreteria: ["Swimming Pool","Newly Build"],
